"""AFABench-shaped thin adapter over Meta-Jev IG policies (P2).
...
class AFABenchAdapter:
    """Thin adapter: Meta-Jev StaticIGAcquisitionPolicy ↔ AFAMethod shape."""
    ...
    def to_afabench_method(self) -> Any:
        ...
        Meta-Jev keeps a thin protocol-compatible adapter and does not vendor
