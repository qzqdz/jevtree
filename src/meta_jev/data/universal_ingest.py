...
Single product door for Meta-Jev. Schema is validated in code; invalid LLM
...
from meta_jev.data.messy_ingest import (
        ...
        try:
            ...
            if not os.environ.get("META_JEV_LLM_API_KEY"):
                raise RuntimeError(
                    ...
                    "The unified entry `meta-jev decide` needs an LLM key to "
            ...
            raise RuntimeError(
                ...
                "Set META_JEV_LLM_* in .env for `meta-jev decide`."
            ) from exc
