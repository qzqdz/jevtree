"""Real tabular dataset loaders for Meta-Jev hard-budget eval (P2).
...
from meta_jev.data.cube import dataset_hash as rows_dataset_hash
...
def _download(url: str, dest: Path, *, timeout: float = 180.0) -> Path:
    ...
    req = urllib.request.Request(url, headers={"User-Agent": "Meta-Jev/0.1 (research)"})
