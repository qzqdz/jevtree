...
from jevtree.data.feature_table import FeatureTable, IngestResult, coerce_labels_discrete
...
def ingest_messy_text(
    ...
    *chat_fn(messages, **kw) -> dict* should match jevtree.llm.mimo.chat_completion.
    """
    ...
    if chat_fn is None:
        try:
            ...
            raise RuntimeError(
                ...
                "Set JEVTREE_LLM_* for `jevtree decide`."
            ) from exc
