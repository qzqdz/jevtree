...
class DecisionTreeGrower(ABC):
    ...
    Implementations should call jevtree.core.entropy.best_split (or equivalents)
...
class IGDecisionTreeGrower(DecisionTreeGrower):
    """ID3-style discrete-feature grower driven by jevtree.core.entropy.best_split."""
    ...
    def fit(
        ...
        *,
        ...
        from jevtree.core.entropy import best_split, partition
